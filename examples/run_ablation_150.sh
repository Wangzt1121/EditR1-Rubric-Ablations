...
echo "[ablation] name=${EXPERIMENT} steps=${NUM_EPOCHS} lr=${LORA_LEARNING_RATE} eval_every=${EVAL_FREQ} eval_samples=${EVAL_SAMPLE_COUNT} mode=${SINGLE_REWARD_MODE} rubric=${SINGLE_REWARD_RUBRIC_YAML} logdir=${LOGDIR}"
